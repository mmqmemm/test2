...
管理员页面中，左侧的导航和顶部栏是每个页面都有的，因此，考虑将它们抽离出来，作为公共模板引用。
...
<div id="wrapper">
    ...
    <nav th:fragment="navbar" class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">商品管理</span><span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a th:href="@{/admin/goods/category}">商品类别</a></li>
                        <li><a th:href="@{/admin/goods/newGoods}">新增商品</a></li>
                        <li><a th:href="@{/admin/goods/goodsList}">商品列表</a></li>
                    </ul>
                </li>
                <li>
                    <a href="#"><i class="fa fa-edit"></i> <span class="nav-label">用户管理</span><span
                            class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a th:href="@{/admin/user/userList}">用户列表</a></li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    <a href="css_animation.html"><i class="fa fa-magic"></i> <span class="nav-label">CSS动画
                            </span><span class="label label-info pull-right">62</span></a>
                </li>
                <li class="landing_link">
                    <a target="_blank" href="landing.html"><i class="fa fa-star"></i> <span
                            class="nav-label">着陆页</span> <span class="label label-warning pull-right">NEW</span></a>
                </li>
    ...
    <div id="page-wrapper" class="gray-bg">
        <div th:fragment="topbar" class="row border-bottom">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" th:src="@{/img/profile.jpg}">
                                    </a>
                                    <div class="media-body ">
...
<head>
    <title>管理员首页</title>
    <div th:replace="~{admin/layout :: head}"></div>
</head>
...
<div th:replace="~{admin/layout :: script}"></div>
</body>
</html>
```
...
用户登录时，将密码使用 MD5 加密，然后查询数据库中的用户表，验证登录。
